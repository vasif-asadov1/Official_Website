...
Welcome to the Data Analysis section of my portfolio. Here, you will find comprehensive, end-to-end data analytics case studies focusing on business performance, customer behavior, and risk assessment.

In this section, I showcase my ability to extract actionable insights from complex datasets using tools like **SQL (DuckDB, SQL Server)**, **Python (Pandas, Polars)**, and **Power BI**.

## Highlighted Projects

<div class="grid cards" markdown>

-   __AdventureWorks Bike Sales__
...
-   __Home Credit Default Risk__
    ...
    [Read Full Documentation ➜](olist_e_commerce/home_credit_risk/00_problem_description.md)
